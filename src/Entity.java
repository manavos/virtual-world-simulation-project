...
public class Entity {
    ...
    public void executeBehavior(World world, ImageLibrary imageLibrary, EventScheduler scheduler) {
        switch(kind) {
            case DUDE:
                executeDudeBehavior(world, imageLibrary, scheduler);
                break;
            case FAIRY:
                executeFairyBehavior(world, imageLibrary, scheduler);
                break;
            case MUSHROOM:
                executeMushroomBehavior(world, imageLibrary, scheduler);
                break;
            case SAPLING:
                executeSaplingBehavior(world, imageLibrary, scheduler);
                break;
            case TREE:
                executeTreeBehavior(world, imageLibrary, scheduler);
                break;
            default:
                throw new UnsupportedOperationException(String.format("executeBehavior not supported for %s", kind));
        }
    }

    /** Executes Dude specific Logic. */
    public void executeDudeBehavior(World world, ImageLibrary imageLibrary, EventScheduler scheduler) {
    ...
    public void executeFairyBehavior(World world, ImageLibrary imageLibrary, EventScheduler scheduler) {
    ...
    public void executeMushroomBehavior(World world, ImageLibrary imageLibrary, EventScheduler scheduler) {
    ...
    public void executeSaplingBehavior(World world, ImageLibrary imageLibrary, EventScheduler scheduler) {
        health = health + 1;
    ...
    public void executeTreeBehavior(World world, ImageLibrary imageLibrary, EventScheduler scheduler) {
